        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('seller.dashboard') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'dashboard' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
            ...
            <li>
                <button onclick="toggleProductMenu()"
                    class="flex items-center justify-between w-full px-4 py-3 rounded-lg {{ $activeMenu === 'products' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <div class="flex items-center space-x-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <ul id="productSubmenu" class="mt-2 space-y-1 {{ $productMenuOpen ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('seller.products.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.products.index') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                    ...
                    <li>
                        <a href="{{ route('seller.products.create') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.products.create') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('seller.products.pending') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.products.pending') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.products.rejected') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.products.rejected') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.categories.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.categories.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.colors.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.colors.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.fabrics.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.fabrics.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('seller.sizes.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.sizes.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.brands.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.brands.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.collections.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.collections.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('seller.tags.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('seller.tags.*') ? 'bg-indigo-500 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                            </svg>
            ...
            <li>
                <a href="{{ route('seller.orders.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'orders' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('seller.wallet.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'wallet' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="ml-auto bg-green-100 text-green-800 text-xs font-bold px-2 py-1 rounded-full">
                        ₹{{ number_format(auth('seller')->user()->wallet->balance ?? 0, 0) }}
                    </span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('seller.returns.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'returns' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('seller.payouts.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'payouts' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('seller.notifications.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'notifications' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('seller.settings.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'settings' ? 'bg-indigo-600 text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex items-center space-x-3 px-3 py-3 mb-3 bg-gray-50 rounded-xl">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-gray-500 truncate">
                    {{ auth('seller')->user() ? auth('seller')->user()->user->email : '' }}
                </p>
            </div>
        </div>
