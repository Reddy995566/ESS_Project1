...
<form id="stepForm" action="{{ route('seller.products.create.step1.process') }}" method="POST">
    @csrf
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="p-8 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="detailedDescriptionHidden" class="hidden" required>{{ old('description', $productData['description'] ?? '') }}</textarea>
            ...
            <div>
                ...
                <textarea name="washing_instructions" id="washingInstructionsHidden" class="hidden">{{ old('washing_instructions', $productData['washing_instructions'] ?? '') }}</textarea>
            ...
            <div>
                ...
                <textarea name="shipping_information" id="shippingInformationHidden" class="hidden">{{ old('shipping_information', $productData['shipping_information'] ?? '') }}</textarea>
            ...
            <div>
                ...
                <textarea name="returns_refunds" id="returnsRefundsHidden" class="hidden">{{ old('returns_refunds', $productData['returns_refunds'] ?? '') }}</textarea>
