                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 font-medium text-gray-900"
                                       placeholder="0.00"
                                       required>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 font-medium text-gray-900"
                                   placeholder="0"
                                   min="0"
                                   required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="stock_status" 
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 font-medium text-gray-900 bg-white">
                    ...
                    <div class="mt-6">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   class="rounded text-indigo-600 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
...
document.getElementById('updateBtn')?.addEventListener('click', function(e) {
    ...
    .then(data => {
        if (data.success) {
            showNotification('Step 3 updated successfully!', 'success');
