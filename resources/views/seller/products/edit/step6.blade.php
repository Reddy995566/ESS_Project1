            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 border-2 border-gray-200 rounded-lg p-6">
                    ...
                    <div class="bg-white p-4 rounded-lg border shadow-sm">
                        <div class="space-y-1">
                            <div id="previewTitle" class="text-indigo-600 text-lg font-medium hover:underline cursor-pointer" style="line-height: 1.3;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateGooglePreview() {
        ...
        if (title.length > 60) {
            previewTitle.className = 'text-indigo-600 text-lg font-medium hover:underline cursor-pointer truncate';
        } else {
            previewTitle.className = 'text-indigo-600 text-lg font-medium hover:underline cursor-pointer';
        }
    }
