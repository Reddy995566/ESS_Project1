...
<body>
    <div class="email-container">
        <div class="header">
            @if($siteLogo)<img src="{{ $siteLogo }}" alt="{{ $siteName }}" class="logo">@endif
        ...
        <div class="content">
            ...
            <p class="message">Someone has subscribed to your newsletter on {{ $siteName }}.</p>
            <div class="subscriber-box">
                <div class="email-display">{{ $newsletter->email }}</div>
                <div class="date-display">Subscribed: {{ $newsletter->created_at->format('d M, Y h:i A') }}</div>
            </div>
            <div class="divider"></div>
            <center><a href="{{ route('admin.newsletters.index') }}" class="button">View All Subscribers</a></center>
            <p class="message" style="margin-top: 30px; font-size: 14px; color: #6B6B6B;">Your subscriber list is growing!</p>
        </div>
        <div class="footer">
            <div class="footer-text"><strong>{{ $siteName }} - Admin Notification System</strong></div>
            <div class="divider"></div>
            <div class="footer-text" style="font-size: 11px; color: #999;">This is an automated notification.</div>
            <div class="footer-text" style="font-size: 12px; color: #6B6B6B; margin-top: 10px;">© {{ date('Y') }} {{ $siteName }}. All rights reserved.</div>
        </div>
    </div>
</body>
</html>
