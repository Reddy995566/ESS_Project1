...
<script>
    ...
    function showConfirmDialog(title, message, onConfirm) {
        ...
        dialog.innerHTML = `
            <div class="p-6">
                <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-yellow-100 to-orange-100">
                ...
                <div class="flex gap-3">
                    ...
                    <button id="confirmBtn" class="flex-1 px-4 py-3 bg-gradient-to-r from-yellow-500 to-orange-600 text-white font-semibold rounded-xl hover:from-yellow-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-xl">
                        Confirm
                    </button>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('exportBtn')?.addEventListener('click', function () {
            showToastNotification('Export feature coming soon', 'success');
        });
        ...
        document.getElementById('applyBulkAction')?.addEventListener('click', function () {
            ...
            showConfirmDialog(
                ...
                `Are you sure you want to ${actionLabels[action] || action} ${selected.length} selected review${selected.length > 1 ? 's' : ''}?`,
                () => {
        ...
        function performBulkAction(action, selected) {
            const url = action === 'approve' ? '/admin/reviews/bulk-approve' : '/admin/reviews/bulk-delete';
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        showToastNotification(data.message || 'Error occurred', 'error');
                    }
                })
        ...
        function applyFilters() {
            ...
            document.querySelectorAll('#reviewsTable tbody tr:not(#emptyState)').forEach(row => {
                ...
                const shouldShow = statusMatch && ratingMatch && searchMatch;
            ...
            const allRows = document.querySelectorAll('#reviewsTable tbody tr:not(#emptyState)');
