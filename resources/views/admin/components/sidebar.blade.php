@php
    ...
    if (str_contains($routeName, 'dashboard')) {
        ...
        $activeMenu = 'products';
        $productMenuOpen = true;
    } elseif (str_contains($routeName, 'colors') || str_starts_with($routeName, 'admin.colors')) {
        $activeMenu = 'products';
        $productMenuOpen = true;
    } elseif (str_contains($routeName, 'fabrics') || str_starts_with($routeName, 'admin.fabrics')) {
        $activeMenu = 'products';
        $productMenuOpen = true;
        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'dashboard' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
            ...
            <li>
                <button onclick="toggleProductMenu()"
                    class="flex items-center justify-between w-full px-4 py-3 rounded-lg {{ $activeMenu === 'products' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <div class="flex items-center space-x-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <svg id="productMenuIcon"
                        class="w-4 h-4 transition-transform duration-200 {{ $productMenuOpen ? 'rotate-180' : '' }}"
                ...
                <!-- Submenu -->
                <ul id="productSubmenu" class="mt-2 space-y-1 {{ $productMenuOpen ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('admin.products') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.products') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                    ...
                    <li>
                        <a href="{{ route('admin.products.create') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.products.create') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v16m8-8H4" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.categories.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.categories.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('admin.colors.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.colors.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('admin.fabrics.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.fabrics.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.collections.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.collections.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    {{-- <li>
                        <a href="{{ route('admin.tags.index') }}"
                            class="flex items-center space-x-3 px-4 py-2.5 pl-12 rounded-lg text-sm {{ request()->routeIs('admin.tags.*') ? 'bg-gray-900 text-white' : 'text-gray-700 hover:bg-white hover:text-gray-900' }} transition-all duration-150">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                            </svg>
            ...
            <li>
                <a href="{{ route('admin.coupons.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'coupons' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.banners.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'banners' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            {{-- <li>
                <a href="{{ route('admin.lookbooks.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ str_contains($routeName, 'lookbooks') ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
            ...
            {{-- <li>
                <a href="{{ route('admin.blogs.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ str_contains($routeName, 'blogs') ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.orders.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'orders' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.orders.cancelled') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'cancelled-orders' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.bulk-orders.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'bulk-orders' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    <span class="text-sm font-medium">Bulk Orders</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin.contacts.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'contacts' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.users.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'users' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.reviews.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'reviews' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.testimonials.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'testimonials' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
            ...
            <!-- Video Reels -->
            <li>
                <a href="{{ route('admin.video-reels.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'video-reels' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                    </svg>
                    <span class="text-sm font-medium">Video Reels</span>
                </a>
            </li>

            <!-- Promotional Banners -->
            <li>
                <a href="{{ route('admin.promotional-banners.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'promotional-banners' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    <span class="text-sm font-medium">Promo Banners</span>
                </a>
            </li>

            <!-- Budget Cards (Shop By Budget) -->
            <li>
                <a href="{{ route('admin.budget-cards.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'budget-cards' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span class="text-sm font-medium">Shop By Budget</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin-users.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'admin-management' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ url('/admin/activity-logs') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'activity-logs' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
            ...
            <li>
                <a href="{{ route('admin.settings') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ $activeMenu === 'settings' ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('admin.theme-settings.index') }}"
                    class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.theme-settings.*') ? 'bg-black text-white' : 'text-gray-700 hover:bg-white' }} transition-all duration-150">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                    </svg>
                    <span class="text-sm font-medium">Theme Settings</span>
                </a>
            </li>
        </ul>
    </nav>
    ...
    <div class="border-t border-gray-100 p-4">
        <div class="flex items-center space-x-3 px-3 py-3 mb-3 bg-gray-50 rounded-xl">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-gray-500 truncate">{{ session('admin_email') }}</p>
            </div>
        </div>
