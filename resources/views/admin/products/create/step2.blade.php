...
<form id="stepForm" action="{{ route('admin.products.create.step2.process') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @elseif(session('product_data.variants_data'))
        try {
            const sessionVariants = @json(json_decode(session('product_data.variants_data'), true));
