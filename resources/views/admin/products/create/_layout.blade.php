        ...
        <div class="w-full px-6 py-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-5">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">@yield('step_title', 'Create Product')</h1>
                        <p class="text-gray-600 font-medium">@yield('step_description', 'Build your product catalog')</p>
                    </div>
                </div>
...
<script src="{{ asset('admin_assets/js/product-create-ajax.js') }}"></script>
...
document.getElementById('clearSessionBtn')?.addEventListener('click', function() {
    if (confirm('Are you sure you want to clear all progress and start over? This cannot be undone.')) {
        fetch('{{ route("admin.products.create.clear-session") }}', {
            method: 'POST',
            headers: {
