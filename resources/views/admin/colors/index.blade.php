            ...
            <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center h-12 px-4 bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-purple-600">{{ $colors->firstItem() ?? 0 }}</span> to <span class="font-bold text-purple-600">{{ $colors->lastItem() ?? 0 }}</span> of <span class="font-bold text-purple-600">{{ $colors->total() }}</span> entries
                    </div>
                    @if($colors->hasPages())
