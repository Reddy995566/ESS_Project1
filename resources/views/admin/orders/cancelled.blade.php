    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-pink-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.orders.index') }}" class="inline-flex items-center px-5 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 shadow-sm hover:shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-purple-600 rounded-2xl shadow-xl p-6">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">{{ $orders->where('cancelled_by', 'admin')->count() }}</p>
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 transition-all duration-200">
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-bold 
                                    ...
                                    @elseif($order->cancelled_by === 'admin') bg-purple-100 text-purple-700 border border-purple-300
                            ...
                            <td class="px-4 py-4 text-center">
                                <a href="{{ route('admin.orders.show', $order->id) }}" class="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xs font-semibold rounded-lg hover:from-blue-600 hover:to-indigo-700 shadow-md hover:shadow-lg transition-all">
