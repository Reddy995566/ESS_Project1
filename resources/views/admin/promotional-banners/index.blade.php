    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-black text-gray-900 tracking-tight">Promotional Banners</h1>
                    <p class="mt-1 text-sm text-gray-600">Manage promotional banners (Desktop + Mobile images)</p>
                </div>
            </div>
            <button onclick="window.openAddModal()" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
        ...
        <div class="bg-blue-600 rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-black mt-1">{{ $scheduledBanners }}</p>
                </div>
                <div class="w-12 h-12 bg-white bg-opacity-20 rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">
                            @if($banner->start_date || $banner->end_date)
                                ...
                                <p>From: {{ $banner->start_date->format('M d, Y') }}</p>
                                @endif
                                @if($banner->end_date)
                                <p>To: {{ $banner->end_date->format('M d, Y') }}</p>
                                @endif
                            @else
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="text-lg font-medium">No promotional banners yet</p>
                            <p class="text-sm">Click "Add Banner" to create your first promotional banner.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-auto transform transition-all">
            <form id="bannerForm" method="POST" enctype="multipart/form-data">
                ...
                <!-- Modal Header -->
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-pink-600 rounded-t-2xl">
                    <h3 id="modalTitle" class="text-xl font-bold text-white">Add Promotional Banner</h3>
                </div>
                ...
                <div class="px-6 py-6 max-h-[70vh] overflow-y-auto">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="position" id="bannerPosition" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Desktop Image * <span class="text-gray-400 font-normal">(2800x1100 recommended)</span></label>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-purple-500 transition-colors">
                        ...
                        <!-- Mobile Image Upload -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Mobile Image * <span class="text-gray-400 font-normal">(1080x1200 recommended)</span></label>
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-purple-500 transition-colors">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="link" id="bannerLink" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="https://...">
                        </div>
                        
                        <!-- Sort Order -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Sort Order</label>
                            <input type="number" name="sort_order" id="bannerSortOrder" value="0" min="0" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                        </div>
                        
                        <!-- Active Toggle -->
                        <div class="flex items-center">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="checkbox" name="is_active" id="bannerIsActive" value="1" checked class="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="start_date" id="bannerStartDate" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">End Date (Optional)</label>
                            <input type="datetime-local" name="end_date" id="bannerEndDate" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex justify-end space-x-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl hover:from-purple-700 hover:to-pink-700 font-semibold transition-colors">Save Banner</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="text-center">
                ...
                <form id="deleteForm" method="POST">
                    ...
                    <div class="flex justify-center space-x-3">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-red-600 text-white rounded-xl hover:bg-red-700 font-semibold">Delete</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('scripts')
@include('admin.promotional-banners.scripts')
@endpush
