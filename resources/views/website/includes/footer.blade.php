            ...
            <div class="hidden md:grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 lg:gap-10 mb-6">
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    <div class="mb-4">
                        @if(!empty($siteSettings['site_logo']))
                            <img src="{{ $siteSettings['site_logo'] }}" alt="{{ $siteSettings['site_name'] ?? 'The Trusted Store' }}" class="h-10 w-auto object-contain mb-3" style="filter: brightness(0) invert(0.2);">
                        @else
                            <h3 class="text-lg font-bold tracking-wider uppercase" style="color: var(--color-footer-text);">{{ $siteSettings['site_name'] ?? 'The Trusted Store' }}</h3>
                        @endif
                    </div>
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <span class="text-xs" style="color: var(--color-footer-text); opacity: 0.9;">{{ $siteSettings['site_address'] }}</span>
                        </li>
                        @endif
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <a href="tel:{{ $siteSettings['site_phone'] }}" class="text-xs hover:opacity-80 transition-opacity" style="color: var(--color-footer-text); opacity: 0.9;">{{ $siteSettings['site_phone'] }}</a>
                        </li>
                        @endif
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <a href="mailto:{{ $siteSettings['site_email'] }}" class="text-xs hover:opacity-80 transition-opacity" style="color: var(--color-footer-text); opacity: 0.9;">{{ $siteSettings['site_email'] }}</a>
                        </li>
                        @endif
                    </ul>
                    <!-- Social Media Links -->
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-2 pl-4 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        ...
                        <li><a href="{{ route('home') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Home</a>
                        </li>
                        <li><a href="{{ route('shop') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Shop</a>
                        </li>
                        <li><a href="{{ route('about') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">About
                                Us</a></li>
                        <li><a href="#" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Track
                                Order</a></li>
                        <li><a href="{{ route('contact') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Contact
                                Us</a></li>
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-2 pl-4 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        ...
                        <li><a href="{{ route('product.show', $product->slug) }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">{{ $product->name }}</a></li>
                        @empty
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-2 pl-4 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        <li><a href="{{ route('privacy-policy') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Privacy
                                Policy</a></li>
                        <li><a href="{{ route('refund-policy') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Refund
                                Policy</a></li>
                        <li><a href="{{ route('shipping-policy') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Shipping
                                Policy</a></li>
                        <li><a href="{{ route('terms-of-service') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Terms of
                                Service</a></li>
                        <li><a href="{{ route('contact-information') }}" class="text-xs font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Contact
                                Information</a></li>
                    </ul>
                </div>
            ...
            <div class="md:hidden mb-4 mx-0" style="border-top: 1px solid rgba(255,255,255,0.2);">
                ...
                <div style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div
                        ...
                        <a href="{{ route('home') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Home</a>
                        <a href="{{ route('shop') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Shop</a>
                        <a href="{{ route('about') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">About Us</a>
                        <a href="#" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Track Order</a>
                        <a href="{{ route('contact') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Contact Us</a>
                        <a href="{{ route('faqs') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">FAQs</a>
                    </div>
                </div>
                ...
                <div style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div
                        class="hidden pb-3 space-y-1.5 pl-4 border-l border-dashed ml-2 accordion-content" style="border-color: rgba(255,255,255,0.3);">
                        @forelse($bestsellers as $product)
                        <a href="{{ route('product.show', $product->slug) }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">{{ $product->name }}</a>
                        @empty
                ...
                <div style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div
                        class="hidden pb-3 space-y-1.5 pl-4 border-l border-dashed ml-2 accordion-content" style="border-color: rgba(255,255,255,0.3);">
                        <a href="{{ route('privacy-policy') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Privacy Policy</a>
                        <a href="{{ route('refund-policy') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Refund Policy</a>
                        <a href="{{ route('shipping-policy') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Shipping Policy</a>
                        <a href="{{ route('terms-of-service') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Terms of Service</a>
                        <a href="{{ route('contact-information') }}" class="block text-xs py-0.5" style="color: var(--color-footer-text); opacity: 0.8;">Contact Information</a>
                    </div>
                </div>
