                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    <div class="mb-4">
                        @if(!empty($siteSettings['site_logo']))
                            <img src="{{ $siteSettings['site_logo'] }}" alt="{{ $siteSettings['site_name'] ?? 'Fashion Store' }}" class="h-10 w-auto object-contain mb-3" style="filter: brightness(0) invert(0.2);">
                        @else
                            <h3 class="text-lg font-bold tracking-wider uppercase" style="color: var(--color-footer-text);">{{ $siteSettings['site_name'] ?? 'Fashion Store' }}</h3>
                        @endif
                    </div>
                    <ul class="space-y-2">
