...
class SizeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Size::query()->where('seller_id', $seller->id);
        ...
        $totalSizes = Size::where('seller_id', $seller->id)->count();
        $activeSizes = Size::where('seller_id', $seller->id)->where('is_active', true)->count();

        return view('seller.sizes.index', [
            'sizes' => $sizes,
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'name' => $this->getSellerNameValidation('sizes'),
        ...
        try {
            ...
            return redirect()->route('seller.sizes.index')->with('success', 'Size created successfully!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, Size $size)
    {
        ...
        try {
            ...
            return redirect()->route('seller.sizes.index')->with('success', 'Size updated successfully!');
        } catch (\Exception $e) {
            if (request()->expectsJson()) {
                return response()->json([
                    'success' => false,
    ...
    public function destroy(Size $size)
    {
        try {
            ...
            return redirect()->route('seller.sizes.index')
