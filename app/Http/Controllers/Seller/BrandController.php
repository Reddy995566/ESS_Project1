...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Brand::query()->where('seller_id', $seller->id);
        ...
        $totalBrands = Brand::where('seller_id', $seller->id)->count();
        $activeBrands = Brand::where('seller_id', $seller->id)->where('is_active', true)->count();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('seller.brands.index')->with('success', 'Brand created successfully!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, Brand $brand)
    {
        ...
        try {
            ...
            return redirect()->route('seller.brands.index')->with('success', 'Brand updated successfully!');
        } catch (\Exception $e) {
            if (request()->expectsJson()) {
                return response()->json([
                    'success' => false,
