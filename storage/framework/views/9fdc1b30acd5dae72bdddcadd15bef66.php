...
<script>
    ...
    function resetForm() {
        ...
        document.getElementById('colorForm').action = '<?php echo e(route('seller.colors.store')); ?>';
    ...
    function openEditModal(data) {
        ...
        const baseUrl = '<?php echo e(route('seller.colors.index')); ?>';
    ...
    function createColorRow(color) {
        ...
        row.className = 'group hover:bg-gradient-to-r hover:from-indigo-50 hover:to-pink-50 transition-all duration-200';
        ...
        row.innerHTML = `
            ...
            <td class="px-4 py-4">
                <p class="text-sm font-bold text-gray-900 group-hover:text-indigo-700">${escapeHtml(color.name)}</p>
            </td>
...
<?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/colors/scripts.blade.php ENDPATH**/ ?>