<?php $__env->startSection('title', 'Colors Management'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-indigo-500 to-pink-600 rounded-2xl shadow-lg">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Colors Management</h1>
                        <p class="mt-1 text-sm text-gray-600">Manage product colors with hex codes</p>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    ...
                    <button id="refreshBtn" class="inline-flex items-center justify-center w-11 h-11 bg-white text-gray-700 rounded-xl border-2 border-gray-200 hover:border-purple-400 hover:bg-indigo-50 hover:text-indigo-700 transition-all duration-200 shadow-sm hover:shadow-md">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                        </svg>
                    </button>
                    <button onclick="openAddModal()" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-indigo-700 hover:to-pink-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <!-- Total Colors -->
            <div class="bg-rose-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalColors); ?></p>
                    <p class="text-rose-100 text-sm font-medium">Total Colors</p>
                </div>
            </div>

            <!-- Active Colors -->
            <div class="bg-cyan-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center justify-center w-12 h-12 bg-white bg-opacity-20 rounded-xl backdrop-blur-sm">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($activeColors); ?></p>
                    <p class="text-cyan-100 text-sm font-medium">Active Colors</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1 ml-11">Manage all product colors with hex codes</p>
                    </div>
            ...
            <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Search Colors</label>
                        <div class="relative">
                            ...
                            <input type="text" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all" placeholder="Search by name or hex code...">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center h-12 px-4 bg-gradient-to-r from-indigo-50 to-pink-50 border-2 border-purple-200 rounded-xl">
            ...
            <div class="overflow-x-auto">
                <table id="colorsTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-slate-100 to-gray-100">
                        <tr>
                            <th class="px-4 py-4 text-center w-12">
                                <input type="checkbox" id="selectAll" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500">
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-indigo-50 hover:to-pink-50 transition-all duration-200"
                            data-status="<?php echo e($color->is_active ? '1' : '0'); ?>"
                            data-id="<?php echo e($color->id); ?>">
                            
                            <!-- Checkbox -->
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500" value="<?php echo e($color->id); ?>">
                            </td>

                            <!-- ID -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($color->id); ?></span>
                            </td>

                            <!-- Color Preview -->
                            <td class="px-4 py-4 text-center">
                                <div class="flex justify-center">
                                    <div class="w-10 h-10 rounded-lg shadow-md border-2 border-gray-300 group-hover:border-purple-400 transition-all" style="background-color: <?php echo e($color->hex_code ?? '#CCCCCC'); ?>;"></div>
                                </div>
                            </td>

                            <!-- Name -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900 group-hover:text-indigo-700"><?php echo e($color->name); ?></p>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-mono font-bold bg-gradient-to-r from-indigo-100 to-pink-100 text-indigo-700 border border-purple-300">
                                    <?php echo e($color->hex_code ?? '#CCCCCC'); ?>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($color->id); ?>" data-field="is_active" <?php echo e($color->is_active ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-indigo-600 bg-indigo-50 border-2 border-purple-200 rounded-lg hover:bg-indigo-100 hover:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                                            title="Edit Color"
                                            data-id="<?php echo e($color->id); ?>"
                                            data-name="<?php echo e($color->name); ?>"
                                            data-hex-code="<?php echo e($color->hex_code); ?>"
                                            data-sort-order="<?php echo e($color->sort_order); ?>"
                                            data-is-active="<?php echo e($color->is_active ? 'true' : 'false'); ?>">
                        ...
                        <tr id="emptyState">
                            <td colspan="8" class="px-6 py-20">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">No Colors Found</h3>
                                    <p class="text-gray-500 mb-6 max-w-md mx-auto">Start building your color palette by creating your first color.</p>
                                    <button onclick="openAddModal()" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-indigo-700 hover:to-pink-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-indigo-600"><?php echo e($colors->firstItem() ?? 0); ?></span> to <span class="font-bold text-indigo-600"><?php echo e($colors->lastItem() ?? 0); ?></span> of <span class="font-bold text-indigo-600"><?php echo e($colors->total()); ?></span> entries
                    </div>
                    <?php if($colors->hasPages()): ?>
                        <?php echo e($colors->appends(request()->query())->links('admin.pagination.custom')); ?>
    ...
    <!-- Add/Edit Modal -->
    <div id="colorModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <form id="colorForm" method="POST" action="<?php echo e(route('seller.colors.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <h3 id="modalTitle" class="text-xl font-bold text-gray-900">Add New Color</h3>
                            </div>
                    ...
                    <div class="px-6 py-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Color Name *</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" id="submitBtn" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-indigo-700 hover:to-pink-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:scale-100">
                                <svg id="loadingSpinner" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span id="submitBtnText">Create Color</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <?php echo $__env->make('seller.colors.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/colors/index.blade.php ENDPATH**/ ?>