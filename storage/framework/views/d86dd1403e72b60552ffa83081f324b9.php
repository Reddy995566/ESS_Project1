<?php $__env->startSection('step_title', 'Step 3: Pricing & Inventory'); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="stock_status" 
                                ...
                                <option value="in_stock" <?php echo e(old('stock_status', $product->stock_status) == 'in_stock' ? 'selected' : ''); ?>>In Stock</option>
                                <option value="out_of_stock" <?php echo e(old('stock_status', $product->stock_status) == 'out_of_stock' ? 'selected' : ''); ?>>Out of Stock</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   <?php echo e(old('track_inventory', $product->track_inventory ?? 1) ? 'checked' : ''); ?>
...
<?php echo $__env->make('admin.products.edit._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/products/edit/step3.blade.php ENDPATH**/ ?>