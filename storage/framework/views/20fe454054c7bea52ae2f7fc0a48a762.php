<?php $__env->startSection('title', 'Pending Approval - Products'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50 p-6">
    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('seller.products.index')); ?>" class="inline-flex items-center px-5 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-xl border-2 border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                    </svg>
                    Back to All Products
                </a>
                <a href="<?php echo e(route('seller.products.create.step1')); ?>" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-yellow-500 to-orange-600 text-white text-sm font-bold rounded-xl hover:from-yellow-600 hover:to-orange-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($totalPending ?? $products->total()); ?></p>
        ...
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($products->count()); ?></p>
    ...
    <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
            <form method="GET" action="<?php echo e(route('seller.products.pending')); ?>" id="filtersForm">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all" placeholder="Search by name, SKU, or description..." value="<?php echo e(request('search')); ?>">
                        </div>
                    </div>
        ...
        <div class="overflow-x-auto">
            <table id="productsTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="group hover:bg-gradient-to-r hover:from-yellow-50 hover:to-orange-50 transition-all duration-200" data-id="<?php echo e($product->id); ?>">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0 w-14 h-14">
                                    <?php if($product->getFirstImageUrl()): ?>
                                        <img src="<?php echo e($product->getFirstImageUrl()); ?>" alt="<?php echo e($product->name); ?>" class="w-14 h-14 rounded-xl object-cover border-2 border-gray-200 shadow-sm">
                                    <?php else: ?>
                        ...
                        <td class="px-4 py-4 text-center">
                            <div class="flex flex-col items-center">
                                <span class="text-sm font-medium text-gray-900"><?php echo e($product->created_at->format('M d, Y')); ?></span>
                                <span class="text-xs text-gray-500 mt-1"><?php echo e($product->created_at->diffForHumans()); ?></span>
                            </div>
                        </td>
                        ...
                        <td colspan="9" class="px-6 py-20">
                            <div class="text-center">
                                ...
                                <div class="flex justify-center space-x-3">
                                    <a href="<?php echo e(route('seller.products.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 text-sm font-bold rounded-xl hover:from-gray-200 hover:to-gray-300 transition-all">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                                        </svg>
                                        View All Products
                                    </a>
                                    <a href="<?php echo e(route('seller.products.create.step1')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-sm font-bold rounded-xl hover:from-yellow-600 hover:to-orange-600 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="dataTables_info text-sm font-medium text-gray-700">
                    Showing <span class="font-bold text-yellow-600"><?php echo e($products->firstItem() ?? 0); ?></span> to <span class="font-bold text-yellow-600"><?php echo e($products->lastItem() ?? 0); ?></span> of <span class="font-bold text-yellow-600"><?php echo e($products->total()); ?></span> entries
                </div>
...
function initializeFilters() {
    ...
    resetFiltersBtn?.addEventListener('click', function() {
        window.location.href = '<?php echo e(route("seller.products.pending")); ?>';
    });
...
<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/products/pending.blade.php ENDPATH**/ ?>