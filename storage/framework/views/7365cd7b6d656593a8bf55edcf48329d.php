...
<?php $__env->startSection('title', 'Seller Details - ' . $seller->business_name); ?>
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('admin.sellers.index')); ?>" class="flex items-center justify-center w-12 h-12 bg-white rounded-xl shadow-md hover:shadow-lg transition-all">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight"><?php echo e($seller->business_name); ?></h1>
                        <p class="mt-1 text-sm text-gray-600">Registered on <?php echo e($seller->created_at->format('d M, Y')); ?></p>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-black text-indigo-600 mt-2"><?php echo e($stats['total_products']); ?></p>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-black text-green-600 mt-2"><?php echo e($stats['total_orders']); ?></p>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-black text-blue-600 mt-2">₹<?php echo e(number_format($stats['total_sales'], 2)); ?></p>
                            </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->business_name); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Business Type</label>
                                <p class="text-base font-semibold text-gray-900 capitalize"><?php echo e($seller->business_type); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Business Email</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->business_email); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Business Phone</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->business_phone); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">GST Number</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->gst_number ?? 'N/A'); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">PAN Number</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->pan_number); ?></p>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Business Address</label>
                                <p class="text-base font-semibold text-gray-900">
                                    <?php echo e($seller->business_address); ?><br>
                                    <?php echo e($seller->business_city); ?>, <?php echo e($seller->business_state); ?> - <?php echo e($seller->business_pincode); ?>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->bankDetails->account_holder_name); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Account Number</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->bankDetails->account_number); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">IFSC Code</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->bankDetails->ifsc_code); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Bank Name</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->bankDetails->bank_name); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Branch</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->bankDetails->branch_name); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Account Type</label>
                                <p class="text-base font-semibold text-gray-900 capitalize"><?php echo e($seller->bankDetails->account_type); ?></p>
                            </div>
                            <?php if($seller->bankDetails->upi_id): ?>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">UPI ID</label>
                                <p class="text-base font-semibold text-gray-900"><?php echo e($seller->bankDetails->upi_id); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    <div class="bg-gradient-to-r from-purple-500 to-pink-600 px-6 py-4">
                        <h2 class="text-xl font-bold text-white flex items-center">
                            ...
                            Recent Products (<?php echo e($seller->products->take(5)->count()); ?>)
                        </h2>
                    </div>
                    <div class="p-6">
                        <?php if($seller->products->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $seller->products->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all">
                                <div class="flex items-center space-x-3">
                                    <div class="w-12 h-12 bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg flex items-center justify-center">
                                        <span class="text-lg font-bold text-purple-600">#<?php echo e($product->id); ?></span>
                                    </div>
                                    <div>
                                        <p class="font-semibold text-gray-900"><?php echo e($product->product_name); ?></p>
                                        <p class="text-sm text-gray-500">₹<?php echo e(number_format($product->price, 2)); ?></p>
                                    </div>
                                </div>
                                <span class="px-3 py-1 rounded-full text-xs font-bold 
                                    <?php if($product->approval_status == 'approved'): ?> bg-green-100 text-green-700
                                    <?php elseif($product->approval_status == 'pending'): ?> bg-orange-100 text-orange-700
                                    <?php else: ?> bg-red-100 text-red-700
                                    <?php endif; ?>">
                                    <?php echo e(ucfirst($product->approval_status)); ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-base font-semibold text-gray-900"><?php echo e($seller->user->name ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Email</label>
                            <p class="text-base font-semibold text-gray-900"><?php echo e($seller->user->email ?? 'N/A'); ?></p>
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Mobile</label>
                            <p class="text-base font-semibold text-gray-900"><?php echo e($seller->user->mobile ?? 'N/A'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-3xl font-black text-orange-600"><?php echo e($seller->commission_rate); ?>%</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-black text-blue-600">₹<?php echo e(number_format($stats['pending_payout'], 2)); ?></p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function updateStatus(status) {
            ...
            if(confirm(messages[status])) {
                fetch('<?php echo e(route("admin.sellers.update-status", $seller->id)); ?>', {
                    method: 'PUT',
                    headers: {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/sellers/show.blade.php ENDPATH**/ ?>