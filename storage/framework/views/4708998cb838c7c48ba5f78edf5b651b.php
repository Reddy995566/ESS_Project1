        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            ...
            <div class="bg-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalOrders ?? 0); ?></p>
            ...
            <div class="bg-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($pendingOrders ?? 0); ?></p>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($completedOrders ?? 0); ?></p>
            ...
            <div class="bg-red-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <?php
                        ...
                        $cancelledCount = \App\Models\Order::whereHas('items', function($q) use ($seller) {
                            $q->where('seller_id', $seller->id);
                        })->where('status', 'cancelled')->count();
                    ?>
                    <p class="text-4xl font-black mb-1"><?php echo e($cancelledCount); ?></p>
            ...
            <div class="bg-purple-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">₹<?php echo e(number_format($totalEarnings ?? 0, 0)); ?></p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="globalSearch" name="search" value="<?php echo e(request('search')); ?>" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all" placeholder="Search by order number, customer...">
                        </div>
                    </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-indigo-50 hover:to-blue-50 transition-all duration-200"
                            ...
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-indigo-500" value="<?php echo e($order->id); ?>">
                            </td>

                            <!-- Order Number -->
                            <td class="px-4 py-4">
                                <a href="<?php echo e(route('seller.orders.show', $order->id)); ?>" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 hover:underline">
                            ...
                            <td class="px-4 py-4">
                                <div>
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($order->user->name ?? ($order->first_name . ($order->last_name ? ' ' . $order->last_name : ''))); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($order->user->email ?? $order->email); ?></p>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-bold bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-300">
                                    ₹<?php echo e(number_format($order->items->sum('seller_amount'), 2)); ?>
                            ...
                            <td class="px-4 py-4 text-center">
                                ...
                                ?>
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold bg-gradient-to-r <?php echo e($statusColors[$order->status] ?? 'from-gray-100 to-gray-200 text-gray-700 border-gray-300'); ?> border">
                                    <?php echo e($statusIcons[$order->status] ?? ''); ?> <?php echo e(ucfirst($order->status)); ?>

                                </span>
                                <?php if($order->status === 'cancelled' && $order->cancelled_by): ?>
                                    <p class="text-xs text-gray-500 mt-1">by <?php echo e(ucfirst($order->cancelled_by)); ?></p>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('seller.orders.show', $order->id)); ?>" class="inline-flex items-center justify-center w-9 h-9 text-indigo-600 bg-indigo-50 border-2 border-indigo-200 rounded-lg hover:bg-indigo-100 hover:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all" title="View Order">
            ...
            <div class="lg:hidden space-y-4 p-4">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-200 p-4 hover:shadow-lg transition-all duration-200"
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex items-center space-x-3">
                            <input type="checkbox" class="row-select w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-indigo-500" value="<?php echo e($order->id); ?>">
                            <a href="<?php echo e(route('seller.orders.show', $order->id)); ?>" class="text-base font-bold text-indigo-600 hover:text-indigo-800 hover:underline">
                                #<?php echo e($order->order_number); ?>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4 text-sm">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                ...
                                ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-lg text-xs font-bold bg-gradient-to-r <?php echo e($statusColors[$order->status] ?? 'from-gray-100 to-gray-200 text-gray-700 border-gray-300'); ?> border">
                                    <?php echo e($statusIcons[$order->status] ?? ''); ?> <?php echo e(ucfirst($order->status)); ?>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-gray-200">
                        <div class="flex items-center space-x-2">
                            <a href="<?php echo e(route('seller.orders.show', $order->id)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-indigo-600 bg-indigo-50 border border-indigo-200 rounded-lg hover:bg-indigo-100 transition-all" title="View Order">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-indigo-600"><?php echo e($orders->firstItem() ?? 0); ?></span> to <span class="font-bold text-indigo-600"><?php echo e($orders->lastItem() ?? 0); ?></span> of <span class="font-bold text-indigo-600"><?php echo e($orders->total()); ?></span> entries
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/orders/index.blade.php ENDPATH**/ ?>