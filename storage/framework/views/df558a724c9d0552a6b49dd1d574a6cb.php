...
<form id="stepForm" action="<?php echo e(route('seller.products.create.step6.process')); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        nextBtn.addEventListener('click', async function(e) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    window.location.href = result.redirect || '<?php echo e(route("seller.products.index")); ?>';
                } else {
    ...
    if (prevBtn) {
        prevBtn.addEventListener('click', function(e) {
            e.preventDefault();
            window.location.href = '<?php echo e(route("seller.products.create.step6")); ?>';
        });
    }
});
</script>
...
<?php echo $__env->make('seller.products.create._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/products/create/step7.blade.php ENDPATH**/ ?>