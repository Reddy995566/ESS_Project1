                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    <div class="mb-4">
                        <?php if(!empty($siteSettings['site_logo'])): ?>
                            <img src="<?php echo e($siteSettings['site_logo']); ?>" alt="<?php echo e($siteSettings['site_name'] ?? 'Fashion Store'); ?>" class="h-10 w-auto object-contain mb-3" style="filter: brightness(0) invert(0.2);">
                        <?php else: ?>
                            <h3 class="text-lg font-bold tracking-wider uppercase" style="color: var(--color-footer-text);"><?php echo e($siteSettings['site_name'] ?? 'Fashion Store'); ?></h3>
                        <?php endif; ?>
                    </div>
                    <ul class="space-y-2">
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-2 pl-4 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        ...
                        <li class="pt-2 border-t" style="border-color: rgba(68, 18, 39, 0.2);">
                            <a href="<?php echo e(route('seller.register')); ?>" class="text-xs font-bold hover:opacity-80 transition-opacity block" style="color: var(--color-accent-gold);">🏪 Become a Seller</a>
                        </li>
                        <li><a href="<?php echo e(route('seller.login')); ?>" class="text-xs font-medium hover:opacity-80 transition-opacity block pl-4" style="color: var(--color-footer-text);">→ Seller Login</a>
                        </li>
                    </ul>
                </div>
