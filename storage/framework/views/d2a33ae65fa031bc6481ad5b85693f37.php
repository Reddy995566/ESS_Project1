...
<form id="stepForm" action="<?php echo e(route('seller.products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('seller.products.edit._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/products/edit/step2.blade.php ENDPATH**/ ?>