...
<?php $__env->startSection('step_description', 'Update essential product details'); ?>
...
<form id="stepForm" action="<?php echo e(route('admin.products.edit.step1.process', $product->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" id="detailedDescriptionHidden" class="hidden" required><?php echo e(old('description', $product->description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="washing_instructions" id="washingInstructionsHidden" class="hidden"><?php echo e(old('washing_instructions', $product->washing_instructions ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="shipping_information" id="shippingInformationHidden" class="hidden"><?php echo e(old('shipping_information', $product->shipping_information ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="returns_refunds" id="returnsRefundsHidden" class="hidden"><?php echo e(old('returns_refunds', $product->returns_refunds ?? '')); ?></textarea>
...
document.getElementById('prevBtn')?.addEventListener('click', function() {
    window.location.href = '<?php echo e(route("admin.products")); ?>';
});
...
<?php echo $__env->make('admin.products.edit._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/products/edit/step1.blade.php ENDPATH**/ ?>