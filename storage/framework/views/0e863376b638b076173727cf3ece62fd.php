<?php $__env->startSection('title', 'Bulk Orders Management'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-blue-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($stats['total'] ?? 0); ?></p>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($stats['new'] ?? 0); ?></p>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $bulkOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200">
                                <!-- Contact Info -->
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        <span class="text-sm font-bold text-gray-900"><?php echo e($order->name); ?></span>
                                        <span class="text-xs text-gray-500 font-medium"><?php echo e($order->business_name); ?></span>
                                        <div class="mt-1 flex flex-col space-y-0.5">
                                            <a href="mailto:<?php echo e($order->email); ?>" class="text-xs text-blue-600 hover:underline flex items-center">
                                            ...
                                            <a href="tel:<?php echo e($order->phone); ?>" class="text-xs text-green-600 hover:underline flex items-center">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-2">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-900"><?php echo e(Str::limit($order->products_required, 50)); ?></p>
                                        </div>
                                        <div>
                                            <span class="text-xs font-semibold text-gray-500 uppercase tracking-wide">Quantity:</span>
                                            <p class="text-sm font-bold text-gray-900"><?php echo e($order->quantity_required); ?></p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!-- Actions -->
                                <td class="px-6 py-4 text-center">
                                    <form action="<?php echo e(route('admin.bulk-orders.destroy', $order->id)); ?>" method="POST"
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600"><?php echo e($bulkOrders->firstItem() ?? 0); ?></span> to <span
                            class="font-bold text-blue-600"><?php echo e($bulkOrders->lastItem() ?? 0); ?></span> of <span
                            class="font-bold text-blue-600"><?php echo e($bulkOrders->total()); ?></span> entries
                    </div>
                     <div class="dataTables_paginate">
                        <?php echo e($bulkOrders->links()); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/bulk-orders/index.blade.php ENDPATH**/ ?>