    ...
    <div>
        ...
        <div class="relative">
            ...
            <input 
                ...
                class="input-focus block w-full pl-12 pr-4 py-3.5 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none transition-all <?php $__errorArgs = ['email'];
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input 
                ...
                id="password" 
                name="password"
                class="input-focus block w-full pl-12 pr-12 py-3.5 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
            <a href="<?php echo e(route('password.request')); ?>" class="font-semibold text-purple-600 hover:text-purple-500 transition-colors">
                Forgot password?
            </a>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/auth/login-form.blade.php ENDPATH**/ ?>