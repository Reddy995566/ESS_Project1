<?php $__env->startSection('title', 'Bulk Order Enquiry - ' . ($siteSettings['site_name'] ?? 'Fashion Store')); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                // Send request
                fetch("<?php echo e(route('bulk-orders.store')); ?>", options)
                    .then(response => {
...
<?php echo $__env->make('website.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/website/bulk-orders.blade.php ENDPATH**/ ?>