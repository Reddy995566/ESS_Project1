...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-indigo-500 rounded-xl shadow-lg p-6 mb-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold mb-2">Welcome back, <?php echo e(auth('seller')->user()->business_name); ?>!</h1>
        ...
        <div class="stat-card bg-white rounded-xl shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 mt-2">₹<?php echo e(number_format($stats['total_sales'] ?? 0, 2)); ?></h3>
        ...
        <div class="stat-card bg-white rounded-xl shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 mt-2"><?php echo e(number_format($stats['total_orders'] ?? 0)); ?></h3>
        ...
        <div class="stat-card bg-white rounded-xl shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 mt-2"><?php echo e(number_format($stats['active_products'] ?? 0)); ?></h3>
        ...
        <div class="stat-card bg-white rounded-xl shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-3xl font-bold text-gray-800 mt-2">₹<?php echo e(number_format($stats['pending_payouts'] ?? 0, 2)); ?></h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="font-medium text-gray-800 text-sm"><?php echo e(Str::limit($product->product_name, 25)); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($product->units_sold ?? 0); ?> units sold</p>
                    </div>
                    <span class="font-bold text-gray-800 text-sm">₹<?php echo e(number_format($product->revenue ?? 0, 0)); ?></span>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('seller.orders.index')); ?>" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">View All →</a>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $recentOrders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($items->count()); ?> item(s)
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-semibold">₹<?php echo e(number_format($orderData['total'], 2)); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600 font-semibold">₹<?php echo e(number_format($orderData['total'], 2)); ?></td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch('<?php echo e(route("seller.dashboard.sales-chart")); ?>')
...
<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/dashboard.blade.php ENDPATH**/ ?>