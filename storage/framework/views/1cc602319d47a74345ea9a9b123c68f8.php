<?php $__env->startSection('title', 'Sizes Management'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Sizes Management</h1>
                        <p class="mt-1 text-sm text-gray-600">Manage product sizes with abbreviations</p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalSizes); ?></p>
                    <p class="text-orange-100 text-sm font-medium">Total Sizes</p>
                </div>
            </div>
            ...
            <div class="bg-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($activeSizes); ?></p>
                    <p class="text-emerald-100 text-sm font-medium">Active Sizes</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1 ml-11">Manage all product sizes with abbreviations</p>
                    </div>
            ...
            <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Search Sizes</label>
                        <div class="relative">
            ...
            <div class="overflow-x-auto">
                <table id="sizesTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-slate-100 to-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-4 text-center w-32">
                                <span class="text-xs font-black text-gray-700 uppercase">Abbr.</span>
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200"
                            data-status="<?php echo e($size->is_active ? '1' : '0'); ?>"
                            data-id="<?php echo e($size->id); ?>">
                            
                            <!-- Checkbox -->
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" value="<?php echo e($size->id); ?>">
                            </td>

                            <!-- ID -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($size->id); ?></span>
                            </td>

                            <!-- Name -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900 group-hover:text-blue-700"><?php echo e($size->name); ?></p>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-mono font-bold bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 border border-blue-300">
                                    <?php echo e($size->abbreviation ?: 'N/A'); ?>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($size->id); ?>" data-field="is_active" <?php echo e($size->is_active ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-blue-600 bg-blue-50 border-2 border-blue-200 rounded-lg hover:bg-blue-100 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                            ...
                                            data-abbreviation="<?php echo e($size->abbreviation); ?>"
                                            data-sort-order="<?php echo e($size->sort_order); ?>"
                                            data-is-active="<?php echo e($size->is_active ? 'true' : 'false'); ?>">
                        ...
                        <tr id="emptyState">
                            <td colspan="7" class="px-6 py-20">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">No Sizes Found</h3>
                                    <p class="text-gray-500 mb-6 max-w-md mx-auto">Start building your size system by creating your first size.</p>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-blue-600">1</span> to <span class="font-bold text-blue-600"><?php echo e(count($sizes)); ?></span> of <span class="font-bold text-blue-600"><?php echo e(count($sizes)); ?></span> entries
                    </div>
    ...
    <!-- Add/Edit Modal -->
    <div id="sizeModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <form id="sizeForm" method="POST" action="<?php echo e(route('seller.sizes.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <h3 id="modalTitle" class="text-xl font-bold text-gray-900">Add New Size</h3>
                            </div>
                    ...
                    <div class="px-6 py-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Size Name *</label>
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Abbreviation</label>
                                <input type="text" name="abbreviation" id="abbreviation" maxlength="10" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="e.g., M">
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" id="submitBtn" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:scale-100">
                                ...
                                <span id="submitBtnText">Create Size</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <?php echo $__env->make('seller.sizes.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/sizes/index.blade.php ENDPATH**/ ?>