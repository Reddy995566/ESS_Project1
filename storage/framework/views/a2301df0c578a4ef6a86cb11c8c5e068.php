                    ...
                    <nav class="flex mb-2" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="<?php echo e(route('admin.document-verification.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2"><?php echo e($document->document_type_name); ?></span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h1 class="text-3xl font-black text-gray-900 tracking-tight"><?php echo e($document->document_type_name); ?></h1>
                    <p class="mt-1 text-sm text-gray-600"><?php echo e($document->seller->business_name); ?></p>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <?php if($document->verification_status === 'pending'): ?>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('admin.document-verification.index')); ?>" class="inline-flex items-center px-5 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 shadow-sm hover:shadow-md">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            ?>
                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-bold <?php echo e($config['bg']); ?> <?php echo e($config['text']); ?> border <?php echo e($config['border']); ?>">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($document->document_type_name); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-500">Document Name:</span>
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($document->document_name); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-500">File Size:</span>
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($document->file_size_formatted); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-500">File Type:</span>
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e(strtoupper(pathinfo($document->file_path, PATHINFO_EXTENSION))); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-medium text-gray-500">Uploaded:</span>
                                    <span class="text-sm font-semibold text-gray-900"><?php echo e($document->created_at->format('M d, Y H:i A')); ?></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if($document->verifiedBy): ?>
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-semibold text-gray-900"><?php echo e($document->verifiedBy->name); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm font-medium text-gray-500">Verified At:</span>
                                        <span class="text-sm font-semibold text-gray-900"><?php echo e($document->verified_at->format('M d, Y H:i A')); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($document->rejection_reason): ?>
                                    <div class="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                                        <h4 class="text-sm font-medium text-red-800 mb-2">Rejection Reason:</h4>
                                        <p class="text-sm text-red-700"><?php echo e($document->rejection_reason); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <?php if($isImage): ?>
                        ...
                        <div class="text-center">
                            <div class="inline-block border-4 border-gray-200 rounded-xl overflow-hidden shadow-lg">
                                <img src="<?php echo e($document->file_url ?: asset('storage/' . $document->file_path)); ?>" 
                                     alt="<?php echo e($document->document_name); ?>" 
                                     class="max-w-full max-h-96 object-contain">
                            </div>
                            <div class="mt-4">
                                <a href="<?php echo e($document->file_url ?: asset('storage/' . $document->file_path)); ?>" 
                                   target="_blank" 
                    ...
                    <?php elseif($isPdf): ?>
                        ...
                        <div class="text-center">
                            <div class="bg-gray-100 rounded-xl p-8 mb-4">
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($document->document_name); ?></p>
                            </div>
                            <div class="space-x-3">
                                <a href="<?php echo e($document->file_url ?: asset('storage/' . $document->file_path)); ?>" 
                                   target="_blank" 
                    ...
                    <?php else: ?>
                        ...
                        <div class="text-center">
                            <div class="bg-gray-100 rounded-xl p-8 mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 mb-2"><?php echo e(strtoupper($fileExtension)); ?> Document</h3>
                                <p class="text-sm text-gray-600"><?php echo e($document->document_name); ?></p>
                            </div>
                            <a href="<?php echo e($document->file_url ?: asset('storage/' . $document->file_path)); ?>" 
                               download 
        ...
        <div class="lg:col-span-1 space-y-8">
                ...
                <div class="p-6">
                    <div class="text-center mb-6">
                        <div class="w-20 h-20 mx-auto bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center border-4 border-blue-200 mb-4">
                            <span class="text-2xl font-bold text-blue-700"><?php echo e(substr($document->seller->business_name, 0, 1)); ?></span>
                        </div>
                        <h3 class="text-lg font-bold text-gray-900"><?php echo e($document->seller->business_name); ?></h3>
                        <p class="text-sm text-gray-600"><?php echo e($document->seller->contact_person); ?></p>
                    </div>
                    
                    <div class="space-y-4">
                        <div class="flex justify-between">
                            <span class="text-sm font-medium text-gray-500">Email:</span>
                            <span class="text-sm font-semibold text-gray-900"><?php echo e($document->seller->email); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm font-medium text-gray-500">Phone:</span>
                            <span class="text-sm font-semibold text-gray-900"><?php echo e($document->seller->phone); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm font-medium text-gray-500">Status:</span>
                            <?php
                            ...
                            ?>
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold <?php echo e($sellerConfig['bg']); ?> <?php echo e($sellerConfig['text']); ?> border <?php echo e($sellerConfig['border']); ?>">
                                <?php echo e($sellerConfig['icon']); ?> <?php echo e($sellerConfig['label']); ?>

                            </span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm font-medium text-gray-500">Joined:</span>
                            <span class="text-sm font-semibold text-gray-900"><?php echo e($document->seller->created_at->format('M d, Y')); ?></span>
                        </div>
                    </div>

                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <a href="<?php echo e(route('admin.sellers.show', $document->seller)); ?>" 
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <div class="flex justify-between text-sm font-medium text-gray-700 mb-2">
                            ...
                            <span><?php echo e($verificationProgress['completion_percentage']); ?>%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 h-3 rounded-full transition-all duration-300" 
                                 style="width: <?php echo e($verificationProgress['completion_percentage']); ?>%"></div>
                        </div>
                        <div class="flex justify-between text-xs text-gray-500 mt-2">
                            <span><?php echo e($verificationProgress['completed']); ?> of <?php echo e($verificationProgress['total']); ?> completed</span>
                            <?php if($verificationProgress['is_complete']): ?>
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $verificationProgress['progress']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-700"><?php echo e($data['name']); ?></span>
                                <?php
                                    $statusConfig = [
                                        'approved' => ['bg' => 'bg-green-100', 'text' => 'text-green-800', 'border' => 'border-green-300', 'icon' => '✅', 'label' => 'Approved'],
                                        'pending' => ['bg' => 'bg-yellow-100', 'text' => 'text-yellow-800', 'border' => 'border-yellow-300', 'icon' => '⏳', 'label' => 'Pending'],
                                ...
                                ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold <?php echo e($config['bg']); ?> <?php echo e($config['text']); ?> border <?php echo e($config['border']); ?>">
                                    <?php echo e($config['icon']); ?> <?php echo e($config['label']); ?>
            ...
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <?php $__currentLoopData = $otherDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherDoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="flex-1">
                                    <h4 class="text-sm font-semibold text-gray-900"><?php echo e($otherDoc->document_type_name); ?></h4>
                                    <p class="text-xs text-gray-500"><?php echo e($otherDoc->created_at->format('M d, Y')); ?></p>
                                </div>
                                <div class="flex items-center space-x-2">
                                    ...
                                    ?>
                                    <span class="inline-flex items-center px-2 py-1 rounded text-xs font-bold <?php echo e($otherConfig['bg']); ?> <?php echo e($otherConfig['text']); ?>">
                                        <?php echo e($otherConfig['icon']); ?>

                                    </span>
                                    <a href="<?php echo e(route('admin.document-verification.show', $otherDoc)); ?>" 
...
async function handleApproveSubmit(e) {
    ...
    try {
        const response = await fetch(`<?php echo e(route('admin.document-verification.approve', $document)); ?>`, {
            method: 'POST',
            body: formData,
            headers: {
...
async function handleRejectSubmit(e) {
    ...
    try {
        const response = await fetch(`<?php echo e(route('admin.document-verification.reject', $document)); ?>`, {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/document-verification/show.blade.php ENDPATH**/ ?>