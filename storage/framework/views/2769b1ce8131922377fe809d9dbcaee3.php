                ...
                <div class="flex-1 flex flex-col justify-between py-1">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            ${item.color_name ? `<p class="text-xs mt-1" style="color: var(--color-text-muted);">Color: ${item.color_name}</p>` : ''}
                        </div>
...
</script><?php /**PATH C:\xampp\htdocs\my personal project 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\ecom\resources\views/website/includes/cart_drawer.blade.php ENDPATH**/ ?>