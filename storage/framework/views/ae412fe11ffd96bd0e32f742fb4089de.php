...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function performSearch(query) {
            const url = `<?php echo e(route('search.ajax')); ?>?q=${encodeURIComponent(query)}`;
...
</script><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/website/includes/search_sidebar.blade.php ENDPATH**/ ?>