        ...
        <div class="grid lg:grid-cols-2 gap-0 bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="gradient-bg p-12 text-white hidden lg:flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-center space-x-3 mb-8">
                        ...
                        <span class="text-2xl font-bold"><?php echo e(config('app.name')); ?> Admin</span>
                    </div>
            ...
            <div class="p-12 lg:p-16 flex flex-col justify-center">
                ...
                <div class="lg:hidden flex items-center space-x-3 mb-8">
                    ...
                    <span class="text-xl font-bold text-gray-800"><?php echo e(config('app.name')); ?> Admin</span>
                </div>
                ...
                <!-- Login Form -->
                <?php echo $__env->make('admin.auth.login-form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>