                ...
                <div class="flex-shrink-0">
                    <a href="<?php echo e(route('home')); ?>">
                        <?php if(!empty($siteSettings['site_logo'])): ?>
                            <img src="<?php echo e($siteSettings['site_logo']); ?>" alt="<?php echo e($siteSettings['site_name'] ?? 'Fashion Store'); ?>" class="h-8 sm:h-10 md:h-12 w-auto object-contain">
                        <?php else: ?>
                ...
                <div class="flex items-center justify-end gap-3 md:gap-4 flex-shrink-0">
                    ...
                    <div class="relative hidden md:block" x-data="{ open: false }" style="z-index: 9999;">
                        ...
                        <div x-show="open" 
                            ...
                            style="z-index: 99999;">
                            <div class="py-2">
                                <a href="<?php echo e(route('seller.register')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                                    </svg>
                                    <span>Register as Seller</span>
                                </a>
                                <a href="<?php echo e(route('seller.login')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="mobile-menu" class="hidden lg:hidden fixed top-[110px] left-0 right-0 z-40 shadow-lg" style="background-color: var(--color-header-bg); border-top: 1px solid rgba(0,0,0,0.1);">
    <div class="px-4 py-4 space-y-1 max-h-[calc(100vh-110px)] overflow-y-auto">
        ...
        <div class="py-3" style="border-bottom: 1px solid rgba(0,0,0,0.1);">
            ...
            <a href="<?php echo e(route('seller.register')); ?>" class="block text-sm py-2 pl-4" style="color: var(--color-header-text);">→ Register as Seller</a>
            <a href="<?php echo e(route('seller.login')); ?>" class="block text-sm py-2 pl-4" style="color: var(--color-header-text);">→ Seller Login</a>
        </div>
