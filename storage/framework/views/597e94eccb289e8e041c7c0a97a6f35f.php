...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-indigo-50 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Total Tags -->
        <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($totalTags); ?></p>
                <p class="text-indigo-100 text-sm font-medium">Total Tags</p>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($activeTags); ?></p>
        ...
        <div class="bg-gradient-to-br from-gray-500 to-slate-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($inactiveTags); ?></p>
        ...
        <div class="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($usedTags); ?></p>
        ...
        <div class="overflow-x-auto">
            <table id="tagsTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="group hover:bg-gradient-to-r hover:from-indigo-50 hover:to-indigo-50 transition-all duration-200" data-id="<?php echo e($tag->id); ?>" data-status="<?php echo e($tag->is_active ? '1' : '0'); ?>">
                        
                        <!-- Checkbox -->
                        <td class="px-4 py-4 text-center">
                            <input type="checkbox" class="row-select w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500" value="<?php echo e($tag->id); ?>">
                        </td>

                        <!-- ID -->
                        <td class="px-4 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($tag->id); ?></span>
                        </td>

                        <!-- Name -->
                        <td class="px-4 py-4">
                            <div class="flex items-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-sm font-bold bg-gradient-to-r from-indigo-100 to-indigo-100 text-indigo-800 border border-purple-300 mr-3">
                        ...
                        <td class="px-4 py-4 text-center">
                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold 
                                <?php echo e($tag->products_count > 0 ? 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-300' : 'bg-gradient-to-r from-gray-100 to-slate-100 text-gray-500 border border-gray-300'); ?>">
                        ...
                        <td class="px-4 py-4 text-center">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($tag->id); ?>" data-field="is_active" <?php echo e($tag->is_active ? 'checked' : ''); ?>>
                        ...
                        <!-- Created Date -->
                        <td class="px-4 py-4 text-center">
                            <span class="text-xs text-gray-500 font-medium"><?php echo e($tag->created_at->format('M d, Y')); ?></span>
                        </td>
                        ...
                        <td class="px-4 py-4">
                            <div class="flex items-center justify-center space-x-2">
                                <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-indigo-600 bg-indigo-50 border-2 border-purple-200 rounded-lg hover:bg-indigo-100 hover:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                                        ...
                                        data-is-active="<?php echo e($tag->is_active ? 'true' : 'false'); ?>">
                    ...
                    <tr id="emptyState">
                        <td colspan="7" class="px-6 py-20">
                            <div class="text-center">
                                <div class="mx-auto flex items-center justify-center w-24 h-24 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-full mb-6">
        ...
        <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="dataTables_info text-sm font-medium text-gray-700">
                    Showing <span class="font-bold text-indigo-600">1</span> to <span class="font-bold text-indigo-600"><?php echo e(count($tags)); ?></span> of <span class="font-bold text-indigo-600"><?php echo e(count($tags)); ?></span> entries
                </div>
...
<div id="tagModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
            <form id="tagForm" method="POST" action="<?php echo e(route('seller.tags.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('seller.tags.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/tags/index.blade.php ENDPATH**/ ?>