...
<?php $__env->startSection('title', 'Seller Payouts Management'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">₹<?php echo e(number_format($totalPending ?? 0, 0)); ?></p>
            ...
            <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">₹<?php echo e(number_format($totalProcessing ?? 0, 0)); ?></p>
            ...
            <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1">₹<?php echo e(number_format($totalCompleted ?? 0, 0)); ?></p>
            ...
            <div class="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalPayouts ?? 0); ?></p>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all" placeholder="Payout number, seller name...">
                        </div>
                    </div>
                        ...
                        <select name="seller_id" class="block w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                            ...
                            <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($seller->id); ?>" <?php echo e(request('seller_id') == $seller->id ? 'selected' : ''); ?>>
                                    <?php echo e($seller->business_name); ?> (<?php echo e($seller->user->name ?? 'No User'); ?>)
                                </option>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="<?php echo e(route('admin.seller-payouts.index')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-3 rounded-xl font-semibold transition-all">
                                Reset
                            </a>
                        </div>
                    </div>
                ...
                <table id="payoutsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-200"
                            data-status="<?php echo e($payout->status); ?>"
                            data-id="<?php echo e($payout->id); ?>">

                            <!-- Checkbox -->
                            <td class="px-4 py-4">
                                <input type="checkbox" name="payout_ids[]" value="<?php echo e($payout->id); ?>" class="payout-checkbox w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500">
                            </td>

                            <!-- Payout Number -->
                            <td class="px-4 py-4">
                                <p class="text-sm font-bold text-gray-900"><?php echo e($payout->payout_number); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($payout->created_at->format('M d, Y')); ?></p>
                            </td>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0">
                                        <div class="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center">
                                            <span class="text-white font-bold text-sm"><?php echo e(substr($payout->seller->business_name ?? 'S', 0, 1)); ?></span>
                                        </div>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-gray-900"><?php echo e($payout->seller->business_name ?? 'Unknown Business'); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($payout->seller->user->name ?? 'No User'); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-4 text-center">
                                ...
                                ?>
                                <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold bg-gradient-to-r <?php echo e($statusColors[$payout->status] ?? 'from-gray-100 to-gray-200 text-gray-700 border-gray-300'); ?> border">
                                    <?php echo e($statusIcons[$payout->status] ?? '❓'); ?> <?php echo e(ucfirst($payout->status)); ?>
                            ...
                            <!-- Requested Date -->
                            <td class="px-4 py-4 text-center">
                                <p class="text-sm font-medium text-gray-900"><?php echo e($payout->created_at->format('d M, Y')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($payout->created_at->format('h:i A')); ?></p>
                            </td>

                            <!-- Actions -->
                            <td class="px-4 py-4 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.seller-payouts.show', $payout)); ?>" class="inline-flex items-center justify-center w-8 h-8 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-all" title="View Details">
                                    ...
                                    <?php if($payout->status === 'pending'): ?>
                                        <button onclick="approvePayout(<?php echo e($payout->id); ?>)" class="inline-flex items-center justify-center w-8 h-8 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 transition-all" title="Approve">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                            </svg>
                                        </button>
                                        <button onclick="rejectPayout(<?php echo e($payout->id); ?>)" class="inline-flex items-center justify-center w-8 h-8 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 transition-all" title="Reject">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                            </svg>
                                        </button>
                                    <?php elseif($payout->status === 'processing'): ?>
                                        <button onclick="completePayout(<?php echo e($payout->id); ?>)" class="inline-flex items-center justify-center w-8 h-8 bg-purple-100 text-purple-600 rounded-lg hover:bg-purple-200 transition-all" title="Mark Complete">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                                        </button>
            ...
            <?php if($payouts->hasPages()): ?>
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                    <?php echo e($payouts->links('admin.pagination.custom')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/seller-payouts/index.blade.php ENDPATH**/ ?>