            ...
            <div class="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                ...
                <div class="flex gap-3">
                    <div class="w-20 h-24 bg-gray-100 flex-shrink-0 lazy-wrapper">
                        <img data-src="<?php echo e(asset('website/assets/images/product-1.jpg')); ?>" alt="Patola Linen Cream Red Saree"
...
<?php echo $__env->make('website.includes.quick_view_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function renderSuggestions(suggestions, query) {
            ...
            suggestionsList.innerHTML = suggestions.map(s => `
                    <li class="py-2 px-2 hover:bg-gray-50 cursor-pointer text-sm font-medium transition-colors" style="color: var(--color-primary);" onclick="window.location.href='<?php echo e(route('shop')); ?>?search=${encodeURIComponent(s)}'">
...
</script><?php /**PATH C:\xampp\htdocs\my personal project 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\ecom\resources\views/website/includes/search_sidebar.blade.php ENDPATH**/ ?>