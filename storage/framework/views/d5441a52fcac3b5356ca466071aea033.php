...
<?php $__env->startSection('content'); ?>
    <!-- Main Container -->
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-indigo-50 p-6">
        
        <!-- Page Header -->
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl shadow-lg">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                        </svg>
                    </div>
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Collections Management</h1>
                        <p class="mt-1 text-sm text-gray-600">Manage product collections with images</p>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    ...
                    <button onclick="openAddModal()" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-indigo-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($totalCollections); ?></p>
                    <p class="text-indigo-100 text-sm font-medium">Total Collections</p>
                </div>
            </div>

            <!-- Active Collections -->
            <div class="bg-teal-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center justify-center w-12 h-12 bg-white bg-opacity-20 rounded-xl backdrop-blur-sm">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($activeCollections); ?></p>
                    <p class="text-teal-100 text-sm font-medium">Active Collections</p>
                </div>
            </div>
            ...
            <div class="bg-pink-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="px-3 py-1 bg-white bg-opacity-20 backdrop-blur-sm rounded-full text-xs font-bold text-white">Homepage</span>
                </div>
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($homepageCollections); ?></p>
                    <p class="text-pink-100 text-sm font-medium">On Homepage</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-5 border-b border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1 ml-11">Manage all product collections with images</p>
                    </div>
            ...
            <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-1">
                        <label class="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Search Collections</label>
                        <div class="relative">
                            ...
                            <input type="text" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all" placeholder="Search by name or description...">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center h-12 px-4 bg-gradient-to-r from-indigo-50 to-indigo-50 border-2 border-indigo-200 rounded-xl">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
                    ...
                    <select id="homepageFilter" class="px-3 py-2.5 bg-white border-2 border-gray-300 rounded-lg text-sm font-medium focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="overflow-x-auto">
                <table id="collectionsTable" class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-indigo-50 hover:to-indigo-50 transition-all duration-200"
                            data-status="<?php echo e($collection->is_active ? '1' : '0'); ?>"
                            data-homepage="<?php echo e($collection->show_in_homepage ? '1' : '0'); ?>"
                            data-id="<?php echo e($collection->id); ?>">
                            
                            <!-- Checkbox -->
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" class="row-select w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-indigo-500" value="<?php echo e($collection->id); ?>">
                            </td>

                            <!-- ID -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 border border-gray-300">#<?php echo e($collection->id); ?></span>
                            </td>

                            <!-- Image -->
                            <td class="px-4 py-4 text-center">
                                <div class="flex justify-center">
                                    <?php if($collection->imagekit_url || $collection->image): ?>
                                        <img src="<?php echo e($collection->imagekit_thumbnail_url ?: $collection->imagekit_url ?: $collection->image); ?>" alt="<?php echo e($collection->name); ?>" class="w-12 h-12 rounded-lg object-cover shadow-md border-2 border-gray-300 group-hover:border-indigo-400 transition-all">
                                    <?php else: ?>
                            ...
                            <td class="px-4 py-4">
                                <div>
                                    <p class="text-sm font-bold text-gray-900 group-hover:text-indigo-700"><?php echo e($collection->name); ?></p>
                                    <p class="text-xs text-gray-500 mt-1"><?php echo e($collection->slug); ?></p>
                                </div>
                            </td>

                            <!-- Description -->
                            <td class="px-4 py-4">
                                <p class="text-sm text-gray-700 line-clamp-2"><?php echo e(Str::limit($collection->description, 100) ?: 'No description'); ?></p>
                            </td>

                            <!-- Sort Order -->
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-indigo-100 to-indigo-100 text-indigo-700 border border-indigo-300">
                                    <?php echo e($collection->sort_order); ?>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($collection->id); ?>" data-field="is_active" <?php echo e($collection->is_active ? 'checked' : ''); ?>>
                            ...
                            <td class="px-4 py-4 text-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer status-toggle" data-id="<?php echo e($collection->id); ?>" data-field="show_in_homepage" <?php echo e($collection->show_in_homepage ? 'checked' : ''); ?>>
                                    <div class="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-indigo-400 peer-checked:to-pink-500"></div>
                                </label>
                            </td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <button class="edit-btn inline-flex items-center justify-center w-9 h-9 text-indigo-600 bg-indigo-50 border-2 border-indigo-200 rounded-lg hover:bg-indigo-100 hover:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                                            ...
                                            data-id="<?php echo e($collection->id); ?>"
                                            data-name="<?php echo e($collection->name); ?>"
                                            data-slug="<?php echo e($collection->slug); ?>"
                                            data-description="<?php echo e($collection->description); ?>"
                                            data-image="<?php echo e($collection->image); ?>"
                                            data-sort-order="<?php echo e($collection->sort_order); ?>"
                                            data-is-active="<?php echo e($collection->is_active ? 'true' : 'false'); ?>"
                                            data-show-in-homepage="<?php echo e($collection->show_in_homepage ? 'true' : 'false'); ?>">
                        ...
                        <tr id="emptyState">
                            <td colspan="9" class="px-6 py-20">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-xl font-bold text-gray-900 mb-2">No Collections Found</h3>
                                    <p class="text-gray-500 mb-6 max-w-md mx-auto">Start building your collections by creating your first collection.</p>
                                    <button onclick="openAddModal()" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-indigo-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="dataTables_info text-sm font-medium text-gray-700">
                        Showing <span class="font-bold text-indigo-600">1</span> to <span class="font-bold text-indigo-600"><?php echo e(count($collections)); ?></span> of <span class="font-bold text-indigo-600"><?php echo e(count($collections)); ?></span> entries
                    </div>
    ...
    <!-- Add/Edit Modal -->
    <div id="collectionModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all duration-300 ease-out animate-slideUp sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                <form id="collectionForm" method="POST" action="<?php echo e(route('seller.collections.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <h3 id="modalTitle" class="text-xl font-bold text-gray-900">Add New Collection</h3>
                            </div>
                    ...
                    <div class="px-6 py-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Collection Name *</label>
                                <input type="text" name="name" id="name" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all" placeholder="e.g., Summer Collection">
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                                    Slug
                                    <svg class="w-4 h-4 ml-1 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" title="Auto-generated from name">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                                    </svg>
                                </label>
                                <input type="text" name="slug" id="slug" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all" placeholder="Auto-generated from name">
                                <p class="text-xs text-gray-500 mt-1">✨ Auto-fills from name or manually edit</p>
                            </div>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Description</label>
                            <textarea name="description" id="description" rows="3" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all" placeholder="Collection description..."></textarea>
                        </div>

                        <!-- Image Upload Section -->
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Collection Image</label>
                            ...
                            <div id="uploadProgress" class="mt-4 hidden">
                                <div class="bg-gradient-to-r from-indigo-50 to-indigo-50 border-2 border-indigo-200 rounded-xl p-4">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-sm font-bold text-indigo-900">Uploading to ImageKit...</span>
                                        <span id="uploadPercent" class="text-sm font-bold text-indigo-600">0%</span>
                                    </div>
                                    <div class="w-full bg-indigo-200 rounded-full h-2.5">
                                        <div id="uploadProgressBar" class="bg-gradient-to-r from-indigo-500 to-indigo-600 h-2.5 rounded-full transition-all duration-300" style="width: 0%"></div>
                                    </div>
                                    <p id="uploadStatus" class="text-xs text-indigo-700 mt-2">Preparing image...</p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="sort_order" id="sortOrder" min="0" value="0" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Display Options</label>
                                <div class="space-y-2 mt-3">
                                    <label class="flex items-center">
                                        <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-indigo-500">
                                        <span class="ml-2 text-sm font-medium text-gray-700">Active</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="show_in_homepage" value="1" id="showInHomepage" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500">
                                        <span class="ml-2 text-sm font-medium text-gray-700">Show in Homepage</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-t border-gray-200 flex justify-between items-center">
                        <button type="button" id="fillUpBtn" class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-indigo-600 hover:to-indigo-700 shadow-md hover:shadow-lg transform hover:scale-105 transition-all">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                            </svg>
                            Fill Up
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" id="submitBtn" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-600 text-white text-sm font-bold rounded-xl hover:from-indigo-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:scale-100">
                                <svg id="loadingSpinner" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span id="submitBtnText">Create Collection</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    <?php echo $__env->make('seller.collections.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/collections/index.blade.php ENDPATH**/ ?>