    ...
    <footer class="w-full text-white relative pt-16 pb-0 overflow-hidden" style="background-color: var(--color-footer-bg); color: var(--color-footer-text);">
        ...
        <div class="relative z-10 max-w-[1800px] mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div class="hidden md:grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-16 lg:gap-20 mb-12">
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    <div class="mb-6">
                        <?php if(!empty($siteSettings['site_logo'])): ?>
                            <img src="<?php echo e($siteSettings['site_logo']); ?>" alt="<?php echo e($siteSettings['site_name'] ?? 'Fashion Store'); ?>" class="h-12 w-auto object-contain mb-4" style="filter: brightness(0) invert(0.2);">
                        <?php else: ?>
                            <h3 class="text-xl font-bold tracking-wider uppercase" style="color: var(--color-footer-text);"><?php echo e($siteSettings['site_name'] ?? 'Fashion Store'); ?></h3>
                        <?php endif; ?>
                    </div>
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm" style="color: var(--color-footer-text); opacity: 0.9;"><?php echo e($siteSettings['site_address']); ?></span>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="tel:<?php echo e($siteSettings['site_phone']); ?>" class="text-sm hover:opacity-80 transition-opacity" style="color: var(--color-footer-text); opacity: 0.9;"><?php echo e($siteSettings['site_phone']); ?></a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="mailto:<?php echo e($siteSettings['site_email']); ?>" class="text-sm hover:opacity-80 transition-opacity" style="color: var(--color-footer-text); opacity: 0.9;"><?php echo e($siteSettings['site_email']); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                    <!-- Social Media Links -->
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-3 pl-6 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        ...
                        <li><a href="<?php echo e(route('home')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Home</a>
                        </li>
                        <li><a href="<?php echo e(route('shop')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Shop</a>
                        </li>
                        <li><a href="<?php echo e(route('about')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">About
                                Us</a></li>
                        <li><a href="#" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Track
                                Order</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Contact
                                Us</a></li>
                        <li><a href="<?php echo e(route('faqs')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">FAQs</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-3 pl-6 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        ...
                        <li><a href="<?php echo e(route('product.show', $product->slug)); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);"><?php echo e($product->name); ?></a></li>
                ...
                <div class="flex flex-col items-start px-4 md:px-0">
                    ...
                    <ul class="space-y-3 pl-6 border-l border-dashed" style="border-color: rgba(68, 18, 39, 0.3);">
                        <li><a href="<?php echo e(route('privacy-policy')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Privacy
                                Policy</a></li>
                        <li><a href="<?php echo e(route('refund-policy')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Refund
                                Policy</a></li>
                        <li><a href="<?php echo e(route('shipping-policy')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Shipping
                                Policy</a></li>
                        <li><a href="<?php echo e(route('terms-of-service')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Terms of
                                Service</a></li>
                        <li><a href="<?php echo e(route('contact-information')); ?>" class="text-sm font-medium hover:opacity-80 transition-opacity block" style="color: var(--color-footer-text);">Contact
                                Information</a></li>
                    </ul>
                </div>
            ...
            <div class="md:hidden mb-8 mx-0" style="border-top: 1px solid rgba(255,255,255,0.2);">
                ...
                <div style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Home</a>
                        <a href="<?php echo e(route('shop')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Shop</a>
                        <a href="<?php echo e(route('about')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">About Us</a>
                        <a href="#" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Track Order</a>
                        <a href="<?php echo e(route('contact')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Contact Us</a>
                        <a href="<?php echo e(route('faqs')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">FAQs</a>
                    </div>
                </div>
                ...
                <div style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div
                        class="hidden pb-4 space-y-2 pl-6 border-l border-dashed ml-2 accordion-content" style="border-color: rgba(255,255,255,0.3);">
                        <?php $__empty_1 = true; $__currentLoopData = $bestsellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('product.show', $product->slug)); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;"><?php echo e($product->name); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div style="border-bottom: 1px solid rgba(255,255,255,0.2);">
                    ...
                    <div
                        class="hidden pb-4 space-y-2 pl-6 border-l border-dashed ml-2 accordion-content" style="border-color: rgba(255,255,255,0.3);">
                        <a href="<?php echo e(route('privacy-policy')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Privacy Policy</a>
                        <a href="<?php echo e(route('refund-policy')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Refund Policy</a>
                        <a href="<?php echo e(route('shipping-policy')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Shipping Policy</a>
                        <a href="<?php echo e(route('terms-of-service')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Terms of Service</a>
                        <a href="<?php echo e(route('contact-information')); ?>" class="block text-sm py-1" style="color: var(--color-footer-text); opacity: 0.8;">Contact Information</a>
                    </div>
                </div>
            ...
            <div class="flex flex-row items-end justify-between pb-8 md:pb-12 relative z-20 px-4 pt-4">
                <div class="text-left">
                    <p class="text-xs" style="color: var(--color-footer-text); opacity: 0.9;">© <?php echo e(date('Y')); ?> <?php echo e($siteSettings['site_name'] ?? 'Fashion Store'); ?>.</p>
...
<?php /**PATH C:\xampp\htdocs\my personal project 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\ecom\resources\views/website/includes/footer.blade.php ENDPATH**/ ?>