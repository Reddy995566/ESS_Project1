...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-pink-50 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-gray-500 to-slate-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($products->where('updated_at', '>=', today())->count()); ?></p>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($products->where('updated_at', '>=', now()->startOfWeek())->count()); ?></p>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e($products->whereNotNull('rejection_reason')->count()); ?></p>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="group hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 transition-all duration-200" 
                        ...
                        <td class="px-4 py-4 text-center">
                            ...
                            ?>
                            <div class="text-sm font-medium text-gray-900"><?php echo e($updatedDate->format('M d, Y')); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($updatedDate->diffForHumans()); ?></div>
                        </td>
                        ...
                        <td class="px-4 py-4 text-center">
                            <?php if($product->rejection_reason): ?>
                                <div class="bg-red-50 border border-red-200 rounded-lg p-2">
                                    <p class="text-xs text-red-700 font-medium"><?php echo e(Str::limit($product->rejection_reason, 50)); ?></p>
                                </div>
                            <?php else: ?>
        ...
        <div class="bg-gradient-to-r from-gray-50 to-slate-50 px-6 py-4 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="dataTables_info text-sm font-medium text-gray-700">
                    Showing <span class="font-bold text-red-600"><?php echo e($products->firstItem() ?? 0); ?></span> to <span class="font-bold text-red-600"><?php echo e($products->lastItem() ?? 0); ?></span> of <span class="font-bold text-red-600"><?php echo e($products->total()); ?></span> entries
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/sellers/rejected-products.blade.php ENDPATH**/ ?>