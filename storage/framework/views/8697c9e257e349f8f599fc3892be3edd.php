...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e(number_format($stats['total'])); ?></p>
        ...
        <div class="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e(number_format($stats['pending'])); ?></p>
        ...
        <div class="bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e(number_format($stats['approved'])); ?></p>
        ...
        <div class="bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-all duration-300">
            ...
            <div class="text-white">
                <p class="text-4xl font-black mb-1"><?php echo e(number_format($stats['rejected'])); ?></p>
    ...
    <div class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gray-50 px-6 py-5 border-b border-gray-200">
            <form method="GET" action="<?php echo e(route('admin.document-verification.index')); ?>" id="filtersForm">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <select name="document_type" id="documentTypeFilter" class="block w-full px-4 py-3 bg-white border-2 border-gray-300 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <?php $__currentLoopData = \App\Models\SellerDocument::DOCUMENT_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(request('document_type') === $key ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" id="globalSearch" class="block w-full pl-10 pr-3 py-3 border-2 border-gray-300 rounded-xl bg-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="Business name or contact person..." value="<?php echo e(request('search')); ?>">
                        </div>
                    </div>
            ...
            <table id="documentsTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="group hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200" 
                        ...
                        data-status="<?php echo e($document->verification_status); ?>">
                        
                        <!-- Checkbox -->
                        <td class="px-4 py-4 text-center">
                            <?php if($document->verification_status === 'pending'): ?>
                                <input type="checkbox" class="row-select w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" value="<?php echo e($document->id); ?>">
                            <?php endif; ?>
                        </td>
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0 w-12 h-12">
                                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center border-2 border-blue-200">
                                        <span class="text-sm font-bold text-blue-700"><?php echo e(substr($document->seller->business_name, 0, 1)); ?></span>
                                    </div>
                                </div>
                                <div class="flex-1">
                                    <h3 class="text-sm font-bold text-gray-900 mb-1"><?php echo e($document->seller->business_name); ?></h3>
                                    <p class="text-xs text-gray-500"><?php echo e($document->seller->contact_person); ?></p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-bold bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 border border-blue-300">
                                <?php echo e($document->document_type_name); ?>
                        ...
                        <td class="px-4 py-4">
                            <div>
                                <h4 class="text-sm font-bold text-gray-900 mb-1"><?php echo e($document->document_name); ?></h4>
                                <p class="text-xs text-gray-500"><?php echo e($document->file_size_formatted); ?></p>
                            </div>
                        </td>
                        ...
                        <!-- Uploaded -->
                        <td class="px-4 py-4 text-center">
                            <div class="text-sm text-gray-900"><?php echo e($document->created_at->format('M d, Y')); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($document->created_at->format('H:i')); ?></div>
                        </td>

                        <!-- Verified By -->
                        <td class="px-4 py-4 text-center">
                            <?php if($document->verifiedBy): ?>
                                <div class="text-sm font-medium text-gray-900"><?php echo e($document->verifiedBy->name); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($document->verified_at->format('M d, Y')); ?></div>
                            <?php else: ?>
            ...
            <div class="bg-white px-6 py-4 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Showing <?php echo e($documents->firstItem()); ?> to <?php echo e($documents->lastItem()); ?> of <?php echo e($documents->total()); ?> results
                    </div>
                    <div class="flex items-center space-x-2">
...
function initializeFilters() {
    ...
    resetFiltersBtn?.addEventListener('click', function() {
        window.location.href = '<?php echo e(route("admin.document-verification.index")); ?>';
    });
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/document-verification/index.blade.php ENDPATH**/ ?>