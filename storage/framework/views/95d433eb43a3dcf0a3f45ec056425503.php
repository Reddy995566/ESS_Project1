...
<form id="stepForm" action="<?php echo e(route('admin.products.edit.step2.process', $product->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
window.handleImageUpload = async function(variantId, files) {
    ...
    const uploadPromises = Array.from(files).map(async (file) => {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.upload.image")); ?>', {
                method: 'POST',
                body: formData,
...
<?php echo $__env->make('admin.products.edit._layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/products/edit/step2.blade.php ENDPATH**/ ?>