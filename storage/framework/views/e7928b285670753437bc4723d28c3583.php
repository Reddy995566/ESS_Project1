        ...
        <div class="bg-blue-600 rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-black mt-1"><?php echo e($totalBanners); ?></p>
                </div>
        ...
        <div class="bg-green-600 rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-white text-3xl font-black mt-1"><?php echo e($activeBanners); ?></p>
                </div>
                <div class="w-12 h-12 bg-white bg-opacity-20 rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody id="banners-list" class="divide-y divide-gray-100">
                    ...
                    <tr data-banner-id="<?php echo e($banner->id); ?>" class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <svg class="w-5 h-5 text-gray-400 cursor-grab handle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 8h16M4 16h16"/>
                                </svg>
                                <span class="text-sm font-medium text-gray-700"><?php echo e($banner->order); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="w-32 h-16 rounded-lg overflow-hidden bg-gray-100">
                                <?php if($banner->desktop_imagekit_url): ?>
                                <img src="<?php echo e($banner->desktop_imagekit_url); ?>" alt="Desktop" class="w-full h-full object-cover">
                                <?php elseif($banner->image): ?>
                                <img src="<?php echo e($banner->image); ?>" alt="Desktop" class="w-full h-full object-cover">
                                <?php else: ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="w-16 h-20 rounded-lg overflow-hidden bg-gray-100">
                                <?php if($banner->mobile_imagekit_url): ?>
                                <img src="<?php echo e($banner->mobile_imagekit_url); ?>" alt="Mobile" class="w-full h-full object-cover">
                                <?php else: ?>
                                <div class="w-full h-full flex items-center justify-center text-gray-400 text-xs">No Image</div>
                                <?php endif; ?>
                            </div>
                        ...
                        <td class="px-6 py-4">
                            <?php if($banner->link): ?>
                            <a href="<?php echo e($banner->link); ?>" target="_blank" class="text-sm text-blue-600 hover:underline truncate block max-w-[200px]"><?php echo e(Str::limit($banner->link, 30)); ?></a>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 text-center">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" <?php echo e($banner->is_active ? 'checked' : ''); ?> onchange="toggleStatus(<?php echo e($banner->id); ?>)">
                                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <button onclick="window.openEditModal(<?php echo e($banner->id); ?>)" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </button>
                                <button onclick="window.deleteBanner(<?php echo e($banner->id); ?>)" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Delete">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('admin.banners.scripts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>