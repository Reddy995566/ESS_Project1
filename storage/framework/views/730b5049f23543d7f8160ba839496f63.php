        ...
        <div class="p-6">
            ...
            <form id="completeForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="transaction_date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" value="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
                <div class="mb-4">
...
</div><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/seller-payouts/modals.blade.php ENDPATH**/ ?>