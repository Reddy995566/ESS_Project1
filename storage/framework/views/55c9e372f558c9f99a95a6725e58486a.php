    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-pink-50 p-6">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex items-center space-x-3">
                    <a href="<?php echo e(route('seller.orders.index')); ?>" class="inline-flex items-center px-5 py-2.5 bg-white text-gray-700 text-sm font-semibold rounded-xl border-2 border-gray-200 hover:border-indigo-400 hover:bg-indigo-50 hover:text-indigo-700 transition-all duration-200 shadow-sm hover:shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-indigo-600 rounded-2xl shadow-xl p-6">
                ...
                <div class="text-white">
                    <p class="text-4xl font-black mb-1"><?php echo e($orders->where('cancelled_by', 'seller')->count()); ?></p>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="group hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 transition-all duration-200">
                            ...
                            <td class="px-4 py-4 text-center">
                                <p class="text-sm font-bold text-gray-900">₹<?php echo e(number_format($order->items->sum('seller_amount'), 2)); ?></p>
                            </td>
                            <td class="px-4 py-4 text-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-bold 
                                    ...
                                    <?php elseif($order->cancelled_by === 'seller'): ?> bg-indigo-100 text-indigo-700 border border-indigo-300
                                    <?php else: ?> bg-purple-100 text-purple-700 border border-purple-300
                                    <?php endif; ?>">
                            ...
                            <td class="px-4 py-4 text-center">
                                <a href="<?php echo e(route('seller.orders.show', $order->id)); ?>" class="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white text-xs font-semibold rounded-lg hover:from-indigo-600 hover:to-indigo-700 shadow-md hover:shadow-lg transition-all">
...
<?php echo $__env->make('seller.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/seller/orders/cancelled.blade.php ENDPATH**/ ?>