<?php $__env->startSection('title', 'Review Details - #' . $review->id); ?>
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Review #<?php echo e($review->id); ?></h1>
                        <p class="mt-1 text-sm text-gray-600">Submitted on <?php echo e($review->created_at->format('d M, Y h:i A')); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-2xl font-black text-gray-900"><?php echo e($review->rating); ?>/5</span>
                            </div>
                        </div>
                        ...
                        <?php if($review->title): ?>
                            <div class="mb-6">
                                ...
                                <p class="text-lg font-semibold text-gray-900"><?php echo e($review->title); ?></p>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($review->images->count() > 0): ?>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-3">Uploaded Images
                                    (<?php echo e($review->images->count()); ?>)</label>
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    <?php $__currentLoopData = $review->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="group relative">
                                            <a href="<?php echo e($image->image_url); ?>" target="_blank" class="block">
                                                <img src="<?php echo e($image->thumbnail_url ?? $image->image_url); ?>" alt="Review Image"
                                            ...
                                            <div class="mt-2 text-xs text-gray-500">
                                                <?php echo e($image->width); ?>x<?php echo e($image->height); ?>

                                                <?php if($image->size): ?>
                                                    <br><?php echo e(number_format($image->size / 1024, 2)); ?> KB
                                                <?php endif; ?>
                                            </div>
                                        </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-lg font-bold text-blue-600"><?php echo e($review->helpful_count); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900"><?php echo e($review->name); ?></p>
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Email</label>
                                <p class="text-sm text-gray-700"><?php echo e($review->email); ?></p>
                            </div>
                            <?php if($review->user): ?>
                                <div>
                                    <label class="block text-xs font-bold text-gray-500 uppercase mb-1">User ID</label>
                                    <p class="text-sm text-gray-700"><?php echo e($review->user_id); ?></p>
                                </div>
                                <div>
                    ...
                    <div class="p-6">
                        <?php if($review->product): ?>
                            <?php if($review->product->image_url): ?>
                                <img src="<?php echo e($review->product->image_url); ?>" alt="<?php echo e($review->product->name); ?>"
                                    class="w-full h-48 object-cover rounded-lg mb-4 border-2 border-gray-200">
                            <?php endif; ?>
                            <h3 class="text-base font-bold text-gray-900 mb-2"><?php echo e($review->product->name); ?></h3>
                            <p class="text-sm text-gray-600 mb-3">SKU: <?php echo e($review->product->sku); ?></p>
                            <p class="text-lg font-black text-green-600 mb-4">₹<?php echo e(number_format($review->product->price, 2)); ?>

                            </p>
                            <div class="space-y-2">
                                <a href="<?php echo e(route('product.show', $review->product->slug)); ?>" target="_blank"
                                ...
                                <a href="<?php echo e(route('admin.products.show', $review->product->id)); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ESS_Project1\resources\views/admin/reviews/show.blade.php ENDPATH**/ ?>