...
<script>
    ...
    async function fetchWishlist() {
        ...
        try {
            const response = await fetch('<?php echo e(route("wishlist.data")); ?>');
    ...
    async function removeWishlistItem(wishlistId) {
        ...
        try {
            const response = await fetch('<?php echo e(route("wishlist.remove")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    async function addToWishlist(productId, colorId = null) {
        ...
        try {
            const response = await fetch('<?php echo e(route("wishlist.add")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php /**PATH C:\xampp\htdocs\my personal project 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\ecom\resources\views/website/includes/wishlist_drawer.blade.php ENDPATH**/ ?>